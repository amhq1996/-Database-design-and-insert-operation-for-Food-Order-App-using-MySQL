...
/*Q. 7. Insert following records in cart_items table -*/
  INSERT INTO `cart_items` (`id`, `cartId`,`fooditemId`,`fooditemPrice`, `unitsInCart`)
VALUES
  (1, 1, 4, 10, 4),
  (2, 1, 5, 25, 4),
  (3, 1, 13, 14, 5),
...
/*Q. 10. Insert following records in order_items table -*/
   INSERT INTO `order_items` (`id`, `orderId`,`fooditemId`,`fooditemPrice`,`unitsPruchased`,`isActive`,`createdTs`,`updatedTs`)
VALUES
