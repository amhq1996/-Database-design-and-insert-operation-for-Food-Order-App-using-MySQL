...
CREATE TABLE `cart` (
  ...
  `userId` int NOT NULL,  
  `restaurantId` int NOT NULL,   
  `orderTotalPrice` decimal(10,2) NOT NULL, /*Not sure about orderTotalPrice*/
  `isActive` int NOT NULL DEFAULT '1',
  `createdTs` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedTs` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE `cart_items` (
  `id` int NOT NULL,
  `cartId` int NOT NULL,   /*Not sure about cartId*/
  `fooditemId` int NOT NULL,   /*Not sure about fooditemId*/
  `fooditemPrice` decimal(10,2) NOT NULL, /*Not sure about fooditemPrice*/
  `unitsInCart` int NOT NULL,   /*Not sure about unitsInCart*/
  `isActive` int NOT NULL DEFAULT '1',
  `createdTs` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedTs` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE `order` (
  `id` int NOT NULL,
  `userId` int NOT NULL,   /*Not sure about userId*/
  `restaurantId` int NOT NULL,   /*Not sure about restaurantId*/
  `orderTotalPrice` decimal(10,2) NOT NULL, /*Not sure about orderTotalPrice*/
  `shippingDetailsId` int NOT NULL,   /*Not sure about shippingDetailsId*/
...
CREATE TABLE `order_items` (
  `id` int NOT NULL,
  `orderId` int NOT NULL,   /*Not sure about orderId*/
  `fooditemId` int NOT NULL,   /*Not sure about fooditemId*/
  `fooditemPrice` decimal(10,2) NOT NULL, /*Not sure about fooditemPrice*/
  `unitsPruchased` int NOT NULL,   /*Not sure about unitsPruchased*/
  `isActive` int NOT NULL DEFAULT '1',
  `createdTs` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedTs` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
